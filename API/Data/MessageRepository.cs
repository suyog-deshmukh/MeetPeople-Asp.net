...
namespace API.Data
{
    public class MessageRepository : IMessageRepository
    {
        ...
        public void DeleteMessage(Message messge)
        {
            _context.Messages.Remove(messge);
        }
        ...
        public async Task<IEnumerable<MessageDto>> GetMessagesThread(string currentUsername, string recipientUsername)
        {
            var messages = await _context.Messages
             .Where(m => m.Recipient.UserName == currentUsername &&
              m.Sender.UserName == recipientUsername && m.RecipientDeleted == false || m.Recipient.UserName == recipientUsername && m.Recipient.UserName == recipientUsername && m.SenderDeleted == false)
