...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public override async Task OnConnectedAsync()
        {
            ...
            await Clients.Caller.SendAsync("ReceieveMessageThread", message);
        }
        ...
        private async Task<Group> RemoveFromMessageGroup()
        {
            ...
            var connections = group.Connections.FirstOrDefault(x => x.ConnectionId == Context.ConnectionId);
            _unitOfWork.MessageRepository.RemoveConnection(connections);
            if (await _unitOfWork.Complete()) return group;
